...
VALUES  ('1', '234-1', 'nsrl-name', 'nsrl-org', 'Disabled','Enabled', 'Disabled','Disabled', 'hard disk scsi disk','leave unchanged', 'Connected', 'Enabled','No', 'Bridged', 'Yes','NA', 'SCSI','20GB','Yes', 'No','3D Enabled', '1 cpu', '2048MB');

INSERT INTO diskprint.vmsetting (vmid, osetid, vminstancename, organization, sharing, applicationmenu,  printers, autoprotect, startupdisk, advancedother, sound, usbdevice, otherdevicesconnected, network, cddvdconnected, cddvdusediskimage, harddisktype, disksize, preallocatediskspace, split2gbfile, display, processor, processorram) 
VALUES  ('1', '9480-1','Nist Nsrl', 'NIST', 'Disabled','Enabled', 'Disabled','Disabled', 'Hard Disk SCSI Disk', 'leave unchanged', 'Connected', 'Enabled', 'No', 'NAT', 'Yes', 'NA','IDE Disk','10GB','Yes', 'No', '3D Enabled', '1 cpu', '1024MB');
...
INSERT INTO diskprint.vmsetting (vmid, osetid, vminstancename, organization, sharing, applicationmenu,  printers, autoprotect, startupdisk, advancedother, sound, usbdevice, otherdevicesconnected, network, cddvdconnected, cddvdusediskimage, harddisktype, disksize, preallocatediskspace, split2gbfile, display, processor, processorram)  
VALUES  ('1', '8504-1', 'UNKNOWN', 'NIST','Disabled','Enabled', 'Disabled','Disabled', 'Hard Disk IDE Disk', 'leave unchanged',
'connected', 'Enabled', 'No', 'NAT','Yes','NA','IDE Disk','8GB','Yes', 'No','3D Enabled','1 cpu', '1GB');

INSERT INTO diskprint.vmsetting (vmid, osetid, vminstancename, organization, sharing, applicationmenu,  printers, autoprotect, startupdisk, advancedother, sound, usbdevice, otherdevicesconnected, network, cddvdconnected, cddvdusediskimage, harddisktype, disksize, preallocatediskspace, split2gbfile, display, processor, processorram)
VALUES  ('1', '8504-2', 'UNKNOWN', 'NIST', 'Disabled','Enabled', 'Disabled','Disabled', 'Hard Disk IDE Disk', 'leave unchanged',
